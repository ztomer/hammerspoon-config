...
obj.version = "1.0"
obj.author = "{ ken }"
obj.homepage = "https://github.com/kenbankspeng/hammerspoon-config"
obj.license = "MIT - https://opensource.org/licenses/MIT"

-- original work by ashfinal ashfinal@gmail.com
-- available at https://github.com/Hammerspoon/Spoons
...
function obj:stop() obj.hcal:stop() end

function obj:start() obj.hcal:start() end

function obj:init() obj.hcal:init() end
